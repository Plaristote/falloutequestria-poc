...
class Dialog extends DialogHelper {
  ...
  onWorkComplete() {
    ...
    const grenadeCount = this.dialog.npc.inventory.count("frag-grenade");
    ...
    this.dialog.npc.inventory.removeItemOfType("frag-grenade", grenadeCount);
    this.dialog.player.inventory.removeItemOfType("gemstone", gemstoneCount);
    this.dialog.player.inventory.addItemOfType("frag-grenade", grenadeCount);
